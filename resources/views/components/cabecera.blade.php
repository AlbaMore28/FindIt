          ...
          @auth
            ...
            <div class="flex">
              ...
              <div class="flex flex-col justify-items-start">
                ...
                <div id="dropdownDotsHorizontal" class="z-10 w-44 bg-white rounded divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600 hidden desplegable">
