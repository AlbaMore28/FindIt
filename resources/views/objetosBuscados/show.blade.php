    ...
    <div id="mi-modal-eliminar" class="mi-modal-eliminar hidden" style="position: fixed; inset: 0;">
        ...
        >
            ...
            <div class="flex w-full justify-center">
                ...
                <a id="btn-delete" class="btn waves-effect waves-light boton-form" href="{{route('objetos.destroy', $objetoBuscado->objeto->id)}}">
            ...
            <div class="flex flex-col sm:flex-row info-objeto justify-around sm:h-399">  
                ...
                <div class="flex flex-col h-399 sm:w-7/12 sm:mt-0 mt-10 w-full">
                    ...
                    <div id="contenido-pestania-1" class="flex px-4 sm:px-0 justify-center text-left items-center w-full h-5/6 cuadro_grande bg-white/50 border-2 border-solid border-gray-400">
                        ...
                        <p class="w-full sm:w-96 font-semibold text-blue-gray-dark">{{$objetoBuscado->objeto->descripcion}}</p>
                    </div>
                    ...
                    <div id="contenido-pestania-3" class="flex flex-col justify-center items-center h-5/6 w-full cuadro_grande bg-white/50 border-2 border-solid border-gray-400 hidden">
                        <div class="sm:w-fit py-4 border-y-4 border-double border-blue-gray-dark">
                            ...
                            <div class="flex">
                                ...
                                @if ($objetoBuscado->objeto->tamanio == 'pequenio')
                                    @php
                                        $tamanio = 'pequeño';
                                    @endphp
                                @else
                                    @php
                                        $tamanio = $objetoBuscado->objeto->tamanio;
                                    @endphp
                                @endif
...
@section('js')
    <script async defer src="https://maps.googleapis.com/maps/api/js?key=AIzaSyAvM9oha22BkPlxiQPRNOXCVXu89RjpwGw&libraries=geocoding&callback=initMap"></script>
