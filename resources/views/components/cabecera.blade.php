    ...
    <div class="flex flex-col justify-end h-full">
      <div class="flex flex-row justify-between text-center text-white mb-24 px-6 md:px-12">
        ...
        <a href="{{route('home')}}" class="flex flex-row justify-center text-center">
          ...
          <h1 class="text-5xl font-bold mb-6 titulo">FindIt</h1>
        </a>
        <div class="flex flex-col justify-items-center mt-8">
      ...
      <div class="h-14">
        <ul class="flex flex-row justify-center h-14 nav_bar_cabecera">
          <li class="nav-item px-2">
            <a class="nav-link block pr-2 lg:px-2 pt-5 text-white hover:text-gray-700 focus:text-gray-700 transition duration-150 ease-in-out nav_boton"
