            ...
            <div class="flex items-center">
              ...
              <div class="flex flex-col justify-items-start">
                <div id="tools-desplegable-desktop">
                  <svg id="tools-desplegable-desktop" xmlns="http://www.w3.org/2000/svg" class="hidden sm:flex h-6 w-6 ml-2 tools-desplegable" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
